				...
				<div className="collapse-content space-y-4">
					<div className="bg-base-200 rounded-xl p-4">
						...
						<div className="space-y-4 mt-4">
							<TerminalCommand
								command={
									'curl -fsSL https://fnm.vercel.app/install | bash && source /Users/ashray/.zshrc && `eval "$(fnm env --use-on-cd --shell zsh)" >> ~/.zshrc && source ~/.zshrc && fnm use --install-if-missing 22 && node -v'
								}
							/>
